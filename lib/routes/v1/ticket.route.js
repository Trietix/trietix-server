...
router
    ...
    .get((0, validate_1.validate)(ticket_1.ticketValidation.getTickets), ticket_1.ticketController.getPaystackWebhook)
    .post((0, validate_1.validate)(ticket_1.ticketValidation.getTickets), ticket_1.ticketController.paystackWebHook);
router
