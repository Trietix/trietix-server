...
router
    .route('/:eventId')
    .get((0, auth_1.auth)(), (0, validate_1.validate)(event_1.eventValidation.getEvent), event_1.eventController.getEvent)
    .patch((0, auth_1.auth)(), (0, validate_1.validate)(event_1.eventValidation.updateEvent), event_1.eventController.updateEvent)
    .delete((0, auth_1.auth)(), (0, validate_1.validate)(event_1.eventValidation.deleteEvent), event_1.eventController.deleteEvent);
router
    .route('/:eventId/mail-blast')
    .post((0, validate_1.validate)(event_1.eventValidation.sendEventMailBlast), event_1.eventController.sendEventMailBlast);
