...
router
    ...
    .get((0, validate_1.validate)(event_1.eventValidation.getRecentEventByTopOrganizer), event_1.eventController.getRecentEventByTopOrganizer);
router
    .route('/organizer/:organizer')
    .get((0, validate_1.validate)(event_1.eventValidation.getEventsByOrganizer), event_1.eventController.getEventsByOrganizer);
router
    .route('/organizer/:organizer/title/:title')
    .get((0, validate_1.validate)(event_1.eventValidation.getEventByOrganizer), event_1.eventController.getEventByOrganizer);
router
    .route('/organizer/:organizer/title/:title/tickets')
    .get((0, validate_1.validate)(event_1.eventValidation.getEventTicketsByOrganizer), event_1.eventController.getEventTicketsByOrganizer);
router
    .route('/organizer/:organizer/title/:title/volunteers')
    .get((0, validate_1.validate)(event_1.eventValidation.getEventVolunteersByOrganizer), event_1.eventController.getEventVolunteersByOrganizer);
router
    .route('/title/:title')
