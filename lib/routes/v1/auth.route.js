...
router.route('/forgot-password').post((0, validate_1.validate)(auth_1.authValidation.forgotPassword), auth_1.authController.forgotPassword);
router.route('/reset-password').post((0, validate_1.validate)(auth_1.authValidation.resetPassword), auth_1.authController.resetPassword);
