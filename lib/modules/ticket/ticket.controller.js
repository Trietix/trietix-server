...
exports.deleteTicket = exports.updateTicket = exports.getTicketsByEvent = exports.getTicketsByPrice = exports.getTicketByTransactionId = exports.getTicketsByUser = exports.getTicketsByOrganizer = exports.getTickets = exports.getTicket = exports.createTicket = void 0;
...
exports.createTicket = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, sendMail_1.sendMail)(req.body.email, `Ticket purchase successful [${req.body.ticketId}] - Trietix`, { amount: req.body.amount, url: `https://trietix.vercel.app/ticket/${req.body.ticketId}` }, "user/ticket.hbs");
