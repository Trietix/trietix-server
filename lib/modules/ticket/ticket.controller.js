...
exports.deleteTicket = exports.updateTicket = exports.getTicketsByEvent = exports.getTicketsByPrice = exports.getTicketByTransactionId = exports.getTicketsByUser = exports.getRevenueByOrganizer = exports.getTicketsByOrganizer = exports.getTickets = exports.getTicket = exports.getPaystackWebhook = exports.paystackWebHook = exports.createTicket = void 0;
...
exports.paystackWebHook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const hash = crypto_1.default.createHmac('sha512', config_1.default.paystack.liveSecretKey).update(JSON.stringify(req.body)).digest('hex');
    if (hash == req.headers['x-paystack-signature']) {
        const event = req.body;
        yield ticketService.paystackWebHook(event);
        yield (0, sendMail_1.sendMail)(event.data.metadata.email, `Ticket purchase successful [${event.data.reference}] - Trietix`, { amount: event.data.metadata.amount, url: `https://trietix.com/ticket/${event.data.reference}` }, "user/ticket.hbs");
        res.status(http_status_1.default.CREATED).send({ "message": "Successful" });
    }
    else {
        res.status(http_status_1.default.FORBIDDEN).send({ "message": "Forbidden" });
    }
}));
exports.getPaystackWebhook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.status(http_status_1.default.FORBIDDEN).send({ "message": "Welcome to paystack webhook" });
}));
