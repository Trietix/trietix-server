...
const createTicketBody = {
    ...
    processingFee: joi_1.default.number().required(),
...
exports.getTicket = {
    params: joi_1.default.object().keys({
        ticketId: joi_1.default.string().custom(custom_validation_1.objectId),
    }),
};
...
exports.getTicketsByPrice = {
    params: joi_1.default.object().keys({
        ticketOrganizer: joi_1.default.string(),
    }),
};
exports.updateTicket = {
    params: joi_1.default.object().keys({
        ticketId: joi_1.default.required().custom(custom_validation_1.objectId),
    })
};
