...
exports.deleteTicketById = exports.updateTicketById = exports.getTicketsByEvent = exports.getTicketByTransactionId = exports.getTicketsByUser = exports.getTicketById = exports.getTicketsByPrice = exports.getRevenueByOrganizer = exports.getTicketsByOrganizer = exports.getTickets = exports.paystackWebHook = exports.createTicket = void 0;
...
const createTicket = (ticketBody) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (config_1.default.env === "production") {
            let ticket = yield ticket_model_1.default.findOne({ reference: ticketBody.ticketId });
            if (!ticket) {
                const verification = yield axios_1.default.get(`https://api.paystack.co/transaction/verify/${ticketBody.ticketId}`, { headers });
...
const paystackWebHook = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (payload.event === "charge.success") {
            let ticket = yield ticket_model_1.default.findOne({ reference: payload.data.reference });
            if (!ticket) {
                ...
                let ticket = yield ticket_model_1.default.create(data);
                ...
                throw (new errors_1.ApiError(http_status_1.default.FORBIDDEN, `Not a charge.success event`));
            }
        }
