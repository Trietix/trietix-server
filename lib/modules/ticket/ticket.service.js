...
exports.deleteTicketById = exports.updateTicketById = exports.getTicketsByEvent = exports.getTicketByTransactionId = exports.getTicketsByUser = exports.getTicketById = exports.getTicketsByPrice = exports.getTicketsByOrganizer = exports.getTickets = exports.createTicket = void 0;
...
const createTicket = (ticketBody) => __awaiter(void 0, void 0, void 0, function* () {
    const ticket = yield ticket_model_1.default.create(ticketBody);
    try {
        return ticket;
    }
    catch (err) {
        throw (new errors_1.ApiError(http_status_1.default.NOT_FOUND, `Error- ${err}`));
    }
});
