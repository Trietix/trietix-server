...
exports.deletePayout = exports.updatePayout = exports.getPayout = exports.getPayoutsByEvent = exports.getPayoutsByOrganizer = exports.getAdminAllPayouts = exports.getAllPayouts = exports.createPayout = void 0;
...
exports.getAdminAllPayouts = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const Payout = yield PayoutService.getAdminAllPayouts();
    if (!Payout) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Payouts not found');
    }
    res.send(Payout);
