...
exports.deletePayoutById = exports.updatePayoutById = exports.getPayoutsByEvent = exports.getAllPayoutsByOrganizer = exports.getAdminAllPayouts = exports.getAllPayouts = exports.getPayoutById = exports.createPayout = void 0;
...
const createPayout = (PayoutBody) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (check) {
        throw new errors_1.ApiError(http_status_1.default.FORBIDDEN, `You already requested for payout at ${new Date(check.createdAt).toISOString()}`);
    }
...
const getAdminAllPayouts = () => __awaiter(void 0, void 0, void 0, function* () {
    // let events = await eventModel.find().sort({ createdAt: -1});
    const events = yield event_1.eventModel.find({ isEnded: false, isCancelled: false }).sort({ createdAt: -1 });
    let payouts = yield Promise.all(events.map((event) => __awaiter(void 0, void 0, void 0, function* () {
        let organizer = yield user_1.userModel.findById(event.organizer);
        const tickets = yield ticket_1.ticketModel.find({ event: event._id });
        ...
        return {
            title: event.title,
            organizer: organizer === null || organizer === void 0 ? void 0 : organizer.name,
            ...
            account: {
                bankName: organizer === null || organizer === void 0 ? void 0 : organizer.bank,
                accountNumber: organizer === null || organizer === void 0 ? void 0 : organizer.accountNumber,
                acountName: organizer === null || organizer === void 0 ? void 0 : organizer.accountName,
            }
        };
    })));
    console.log(yield payouts);
    return payouts;
});
exports.getAdminAllPayouts = getAdminAllPayouts;
/**
