...
exports.deleteEventByName = exports.deleteEvent = exports.updateEventByName = exports.updateEvent = exports.getEventsByCategory = exports.getEventVolunteers = exports.getEventsByPrice = exports.getEventTickets = exports.getEventByTitle = exports.getTopEventsByOrganizer = exports.getRecentEventsByOrganizer = exports.getEventsByOrganizer = exports.getRecentEvents = exports.getTopEvents = exports.getInvitesByEvent = exports.getAllInvites = exports.getEvents = exports.getEventByName = exports.getEvent = exports.createEvent = void 0;
...
exports.getTopEvents = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const events = yield eventService.getRecentEvents();
    res.status(http_status_1.default.OK).send(events);
}));
exports.getRecentEvents = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const events = yield eventService.getTopEvents();
    res.status(http_status_1.default.OK).send(events);
}));
...
exports.getRecentEventsByOrganizer = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (typeof req.params['organizer'] === 'string') {
        const event = yield eventService.getRecentEventsByOrganizer(new mongoose_1.default.Types.ObjectId(req.params['organizer']));
        if (!event) {
            throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'No events found');
        }
        res.send(event);
...
exports.getEventByTitle = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (typeof req.params['title'] === 'string') {
        const event = yield eventService.getEventByTitle(req.params['title']);
        if (!event) {
            throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Event not found');
        }
        res.send(event);
...
exports.getEventTickets = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (typeof req.params['title'] === 'string') {
        const event = yield eventService.getEventTickets(req.params['title']);
        if (!event) {
...
exports.getEventsByPrice = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const events = yield eventService.getEventsByPrice(req.params['eventPrice']);
    if (!events) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Events not found');
    }
    res.send(events);
}));
exports.getEventVolunteers = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (typeof req.params['title'] === 'string') {
        const events = yield eventService.getEventVolunteers(req.params['title']);
        if (!events) {
...
exports.getEventsByCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const events = yield eventService.getEventsByCategory(req.params['eventCategory']);
    if (!events) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Events not found');
    }
    res.send(events);
