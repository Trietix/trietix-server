...
exports.sendEventMailBlast = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let { eventName } = yield eventService.sendMailBlast(req.params["eventId"], req.body.eventDay);
