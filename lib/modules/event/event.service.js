...
const sendMailBlast = (eventId, eventDay) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (event) {
            ...
            // await fs.writeFileSync(filePath, emails);
...
const getEvents = () => __awaiter(void 0, void 0, void 0, function* () {
    const events = yield event_model_1.default.find({ isEnded: false, isCancelled: false, isEventVerified: true }).sort({ createdAt: -1 });
    if (!events) {
