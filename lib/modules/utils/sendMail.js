...
function sendMail(to, subject, payload, html, blast, mails, calendar) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const year = new Date().getFullYear();
            const myOAuth2Client = new OAuth2(clientid, clientsecret, "https://developers.google.com/oauthplayground");
            ...
            const transporter = nodemailer_1.default.createTransport({
                ...
                auth: {
                    ...
                    accessToken: (yield myAccessToken).token, //access token variable we defined earlier
                },
            });
...
const removeDuplicateEmails = (arr) => {
