...
const createRequest = (RequestBody) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (check) {
        throw new errors_1.ApiError(http_status_1.default.FORBIDDEN, `You already requested for verification at ${new Date(check.createdAt).toISOString().toLocaleString()}`);
    }
    else {
