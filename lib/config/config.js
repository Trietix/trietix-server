...
const envVarsSchema = joi_1.default.object()
    ...
    NEXT_PUBLIC_PAYSTACK_PUBLIC_KEY: joi_1.default.string(),
    NEXT_SECRET_PAYSTACK_SECRET_KEY: joi_1.default.string(),
    NEXT_LIVE_SECRET_PAYSTACK_KEY: joi_1.default.string(),
    NEXT_LIVE_PUBLIC_PAYSTACK_KEY: joi_1.default.string()
})
    .unknown();
